pipeline {
  ...
  stages {
    ...
    stage('deploy') {
      ...
      steps {
        sh "if ! [ -d '/var/www/html/rectangles/all/${env.BUILD_NUMBER}' ]; then mkdir /var/www/html/rectangles/all/${env.BUILD_NUMBER}; fi"
    ...
    stage("Running on CentOS") {
      ...
      steps {
        sh "wget http://54.90.145.191:8080//rectangles/all/${env.BUILD_NUMBER}/rectangle_${env.MAJOR_VERSION}.${env.BUILD_NUMBER}.jar"
